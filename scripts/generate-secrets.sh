...
>&2 echo "[INFO] Traefik dashboard password: ${TRAEFIK_PASS}"
echo ""
...
echo "POSTGRES_CONSOLE_PASSWORD=$(generate_alphanum 32)"
echo "POSTGRES_PAPERLESS_PASSWORD=$(generate_alphanum 32)"
echo ""
...
>&2 echo "[INFO] Authentik bootstrap password (for setup wizard): ${AUTHENTIK_BOOT_PASS}"
...
>&2 echo "[INFO] Grafana admin password: ${GRAFANA_PASS}"
echo "GRAFANA_OAUTH_CLIENT_ID="
echo "GRAFANA_OAUTH_CLIENT_SECRET="
echo ""

echo "# ==========================================="
echo "# CONSOLE MODULE (Optional)"
echo "# ==========================================="
echo "CONSOLE_AUTH_SECRET=$(generate_alphanum 32)"
echo "CONSOLE_OAUTH_CLIENT_ID="
echo "CONSOLE_OAUTH_CLIENT_SECRET="
echo ""
...
echo "# ==========================================="
echo "# PAPERLESS-NGX MODULE (Optional)"
echo "# ==========================================="
echo "PAPERLESS_SECRET_KEY=$(generate_alphanum 50)"
PAPERLESS_PASS=$(generate_alphanum 16)
echo "PAPERLESS_ADMIN_USER=admin"
echo "PAPERLESS_ADMIN_PASSWORD=${PAPERLESS_PASS}"
>&2 echo "[INFO] Paperless admin password: ${PAPERLESS_PASS}"
echo "PAPERLESS_API_TOKEN=  # Generate in Paperless admin UI after first boot"
echo "PAPERLESS_API_URL=http://op1-paperless:8000/api"
echo ""
...
echo "# SETUP"
echo "# ==========================================="
echo "SETUP_CODE=op1-$(openssl rand -hex 3)"
echo ""

echo "# ==========================================="
echo "# MCP CONFIGURATION"
echo "# ==========================================="
echo "# OpenBao tokens are generated by init-openbao.sh — see above"
